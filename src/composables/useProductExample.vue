...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper circular @change="onSwiperChange">
          <swiper-item v-for="item in goodsInfo?.mainPictures || []" :key="item">
            <image mode="aspectFill" :src="item" @tap="previewImage(item)" lazy-load />
          </swiper-item>
        </swiper>
        <view class="indicator">
          <text class="current">{{ current }}</text>
          <text class="split">/</text>
          <text class="total">{{ imageCount }}</text>
        </view>
      </view>
      ...
      <view class="meta">
        ...
        <view v-if="!hasStock" class="stock-warning">商品已售罄</view>
      </view>
      ...
      <view class="action">
        <view class="item arrow">
          ...
          <text class="text ellipsis" @click="openSkuPopup(SkuMode.Both)"> 请选择商品规格 </text>
        </view>
        <view class="item arrow">
    ...
    <view class="similar panel">
      ...
      <view class="content">
        ...
        >
          <image class="image" mode="aspectFill" :src="item.picture" lazy-load />
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="buttons">
      <view class="addcart" @click="openSkuPopup(SkuMode.Cart)" :class="{ disabled: !hasStock }">
        加入购物车
      </view>
      <view class="buynow" @click="openSkuPopup(SkuMode.Buy)" :class="{ disabled: !hasStock }">
        立即购买
      </view>
    </view>
  </view>
